...
module.exports = (db) => {
  ...
  // CJ Route to add a new resource
  ...
  // CJ creation of new resource and redirect back to my resources
  ...
  //CJ duplicate of homepage logged in via resources/ route
  router.get("/", (req, res) => {
  ...
  // CJ route to view individual resource details
  ...
  // HOA Adding comments, rating or category to existing resource
